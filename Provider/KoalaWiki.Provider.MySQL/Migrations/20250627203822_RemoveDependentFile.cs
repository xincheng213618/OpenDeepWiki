        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChatShareMessageId = table.Column<string>(type: "varchar(255)", nullable: false, comment: "聊天分享消息Id"),
                    CompletionToken = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Files = table.Column<string>(type: "longtext", nullable: false, comment: "相关文件"),
                    PromptToken = table.Column<int>(type: "int", nullable: false),
                    Question = table.Column<string>(type: "longtext", nullable: false, comment: "问题内容"),
