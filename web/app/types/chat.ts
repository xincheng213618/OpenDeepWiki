...
export interface MessageItem {
    id: string;
    content: MessageContentItem[] | MessageContentToolItem[] | MessageContentImageItem[] | MessageContentCodeItem[] | MessageContentTableItem[] | MessageContentLinkItem[] | MessageContentFileItem[] | MessageContentAudioItem[] | MessageContentReasoningItem[];
    role: string;
    createdAt: Date;
    updatedAt: Date;
}
